...
const AgentTicketPanel = () => {
  ...
  const handleUpdateStatus = async (ticketId, status, reply) => {
    try {
      ...
      setLastActionMessage(`✅ Ticket marked as ${status}. Your reply has been sent.`);
  ...
  return (
    ...
    >
      ...
      {lastActionMessage && (
        <div className="mb-6 p-4 bg-green-100 border-l-4 border-green-500 text-green-700 rounded shadow">
          {lastActionMessage}
        </div>
      )}
